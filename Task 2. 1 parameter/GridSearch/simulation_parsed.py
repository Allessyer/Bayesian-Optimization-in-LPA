...
from assel_functions import generate_gaussian_bunch_from_twiss_assel
...
def createParser ():
    ...
    parser.add_argument ('-lmd0', '--lambda0', type=float, default=0.8e-6) # m
    ...
    parser.add_argument ('-head_current','--head_current',type=float,default=0.48)
...
if __name__ == '__main__':
    ...
    head_current = namespace.head_current
